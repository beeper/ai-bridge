...
var modelConfig = struct {
	...
	OpenAIModels: []OpenAIModel{
		...
		},
		{
			...
			Name:                "GPT-5.2 Pro",
			Description:         "GPT-5.2 with extended capabilities",
			SupportsVision:      true,
			SupportsToolCalling: true,
			SupportsReasoning:   true,
			SupportsWebSearch:   true,
		...
		// GPT OSS series
		{
			...
			Name:                "GPT OSS 20B",
			Description:         "Open-source GPT 20B parameters",
		...
		},
		{
			...
			Name:                "GPT OSS 120B",
			Description:         "Open-source GPT 120B parameters",
			SupportsVision:      false,
			SupportsToolCalling: true,
			SupportsReasoning:   false,
			SupportsWebSearch:   false,
