// Package turnval provides turn validation and sanitization utilities for
// OpenAI-style chat prompts, with special handling for Google/Gemini
// models that require strict user↔assistant alternation.
package turnval
